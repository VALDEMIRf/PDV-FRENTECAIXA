...
Public Class frmEstoque
    ...
    Private Sub Listar()
        ...
        Try
            ...
            da = New SqlDataAdapter("pa_estoqueProdutoListar", con)
    ...
    Private Sub atualizarValor()
        ...
        Try
            ...
            Dim cmd2 As New SqlCommand("select imagem from tbProdutos where id_produto = @id", con)
    ...
    Private Sub btnExcluir_Click(sender As Object, e As EventArgs) Handles btnExcluir.Click
        ...
        If txtCodigo.Text <> "" Then
            ...
            Try
                ...
                cmd = New SqlCommand("pa_estoqueExcluir", con)
                cmd.CommandType = CommandType.StoredProcedure
    ...
    Private Sub cbBuscar_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Else
            ...
            Try
                abrir()
                da = New SqlDataAdapter("pa_estoqueBuscar", con)
    ...
    Private Sub cbBuscar_SelectedIndexChanged_1(sender As Object, e As EventArgs) Handles cbBuscar.SelectedIndexChanged
        If cbBuscar.Text = "" And dg.Rows.Count > 0 Then
            Listar()
